...
api.add_resource(adoption.Adopt, '/adopt/<int:pet_id>', strict_slashes=False, endpoint='adopt_endpoint')
api.add_resource(adoption.Adopt, '/adopt', strict_slashes=False)
